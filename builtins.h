 ...
 */
static const char * const BUILTINS[] = {"echo", "ls", "wc", "cat", "cd", "ps", "kill"};
static const bn_ptr BUILTINS_FN[] = {bn_echo, bn_ls, bn_wc, bn_cat, bn_cd, bn_ps, bn_kill, NULL};    // Extra null element for 'non-builtin'
